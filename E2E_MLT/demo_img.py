...
f = open('codec_1211.txt', 'r', encoding='utf-8')
codec = f.readlines()[0]
f.close()
...
if __name__ == '__main__':
    ...
    frame_no = 0
    im = cv2.imread('/data2/sunjunjiao/E2E_MLT/images/point_pick_json/pointer_0.png')
    with torch.no_grad():
        ...
        # cv2.imshow('img', im)
        # cv2.waitKey(10)
        cv2.imwrite('/data2/sunjunjiao/E2E_MLT/result/test.png',im)

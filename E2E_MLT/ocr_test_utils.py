...
def test(net, codec, args, list_file, norm_height=32,
         max_samples=1000000):
    codec_rev = {}
    index = 4
    ...
    fout = open('/data2/sunjunjiao/data/E2Edata/train_e2e_1222/e2e_valid.txt', 'w')
    fout_ocr = open('/data2/sunjunjiao/data/E2Edata/train_e2e_1222/ocr_valid.txt', 'w')

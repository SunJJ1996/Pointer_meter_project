...
image_list, _, _ = file_utils.get_files('test')
...
if __name__ == '__main__':
    # test('/data2/sunjunjiao/CRAFT_Reimplementation/weights/mlt_5_600.pth')
    # test('/data2/sunjunjiao/CRAFT_Reimplementation/craft_mlt_25k.pth')
    # test('Syndata.pth')
    test('/data2/sunjunjiao/CRAFT_Reimplementation/epoch_weights/mlt_19.pth')

...
import re
import water
from generate_polar_line import test
...
if __name__ == '__main__':
    ...
    # box = scio.loadmat('/data2/sunjunjiao/CRAFT_Reimplementation/syntext/SynthText/gt.mat')
    ...
    dataloader = Synth80k('/data2/sunjunjiao/CRAFT_Reimplementation/syntext/SynthText/SynthText', target_size = 768)
    ...
    #net.load_state_dict(copyStateDict(torch.load('/data2/sunjunjiao/CRAFT_Reimplementation/1-7.pth')))
    ...
    # realdata = ICDAR2015(net, '/data2/sunjunjiao/CRAFT_Reimplementation/icdar2015', target_size = 768)
    ...
    for epoch in range(1000):
        ...
        for index, (images, gh_label, gah_label, mask, _) in enumerate(train_loader):
            ...
            if index % 5000 == 0 and index != 0:
                ...
                torch.save(net.module.state_dict(),
                           '/data2/sunjunjiao/CRAFT_Reimplementation/synweights/synweights_' + repr(index) + '.pth')
                test('/data2/sunjunjiao/CRAFT_Reimplementation/synweights/synweights_' + repr(index) + '.pth')

...
import json
import zipfile
from image.draw_polygon_result import draw_polygon_result
...
# image_list, _, _ = file_utils.get_files('/data2/sunjunjiao/CRAFT_Reimplementation/test_origin')
image_list, _, _ = file_utils.get_files('/data2/sunjunjiao/CRAFT_Reimplementation/test_meter')

result_folder = '/data2/sunjunjiao/CRAFT_Reimplementation/result/'
...
if __name__ == '__main__':
    ...
    # test('/data2/sunjunjiao/CRAFT_Reimplementation/weights/mlt_262_100.pth')
    # test('/data2/sunjunjiao/CRAFT_Reimplementation/craft_mlt_25k.pth')
    # test('Syndata.pth')
    test('/data2/sunjunjiao/CRAFT_Reimplementation/epoch_weights/mlt_8.pth')
    # test('/data2/sunjunjiao/CRAFT_Reimplementation/epoch_weights/mlt_5.pth')

...
from CRAFT_Reimplementation.torchutil import *
import os
...
class vgg16_bn(torch.nn.Module):
    def __init__(self, pretrained=True, freeze=False):
        ...
        if pretrained:
            ...
            #     copyStateDict(torch.load(os.path.join(weights_folder, '/data2/sunjunjiao/CRAFT_Reimplementation/vgg16_bn-6c64b313.pth'))))
            vgg_pretrained_features.load_state_dict(
                copyStateDict(torch.load('CRAFT_Reimplementation/vgg16_bn-6c64b313.pth')))

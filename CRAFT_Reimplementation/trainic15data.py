...
if __name__ == '__main__':
    ...
    for epoch in range(1000):
        ...
        torch.save(net.module.state_dict(),
                   '/data2/sunjunjiao/CRAFT_Reimplementation/real_weights/CRAFT_clr_' + repr(epoch) + '.pth')
        test('/data2/sunjunjiao/CRAFT_Reimplementation/real_weights/CRAFT_clr_' + repr(epoch) + '.pth')

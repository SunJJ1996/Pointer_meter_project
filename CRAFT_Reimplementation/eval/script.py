...
from CRAFT_Reimplementation.eval import rrc_evaluation_funcs
import importlib
import zipfile
import os
import numpy as np
...
def default_evaluation_params():
    ...
    return {
        ...
        'GT_SAMPLE_NAME_2_ID': 'pointer_([0-9]+).txt',
        'DET_SAMPLE_NAME_2_ID': 'res_pointer_([0-9]+).txt',
...
def getresult():
    ...
    #eval_2015('../../test')
    resDict = eval_2015('/data2/sunjunjiao/CRAFT_Reimplementation/result')
    return resDict